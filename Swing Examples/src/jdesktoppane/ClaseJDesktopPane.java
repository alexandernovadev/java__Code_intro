...
public class ClaseJDesktopPane extends JDialog  implements ActionListener {
	...
	public ClaseJDesktopPane(VentanaPrincipal miVentanaPrincipal, boolean modal)
	{
		...
		internalFrame.setBounds(10,20,350,200);//definimos un tama�o y una posicion de la ventana
		
		internalFrame2 = new JInternalFrame("Ventana Interna 2");
		internalFrame2.add(panel1);
		internalFrame2.setBounds(10,300,200,100);//definimos un tama�o y una posicion de la ventana
		...
		//internalFrame.setSize(400,200);//con esto se da un tama�o a la ventana
		/*en caso de no darle un tama�o fijo a la ventana,Se invoca el metodo pack()
	...
	private void creaVentana2() {
		...
		internalFrame2 = new JInternalFrame("Ventana Interna 2");
		internalFrame2.add(panel1);
		internalFrame2.setBounds(posA,posB,200,100);//definimos un tama�o y una posicion de la ventana
		internalFrame2.setResizable(true);//permite redimencionar la ventana interna
		internalFrame2.setClosable(true);//permite cerrar la ventana interna
		desktopPane.add(internalFrame2);
		internalFrame2.setVisible(true);
	...
	private void componentesPanel1() {
		...
		texto="Este conetenedor presenta una ventana principal\n" +
				...
				"sera independiente y permite cambiar su posici�n\n" +
				"y tama�o (dependiendo de las propiedades\n asignadas)";
